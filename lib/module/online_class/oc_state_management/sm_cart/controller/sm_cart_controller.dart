...
import '../view/sm_cart_view.dart';

class SmCartController extends State<SmCartView> implements MvcController {
  static late SmCartController instance;
  late SmCartView view;
